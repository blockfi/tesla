defmodule Tesla.Mixfile do
  ...
  defp deps do
    [
      ...
      {:finch, git: "git@github.com:blockfi/finch.git", branch: "lukebakken/sslkeylogfile-with-mint-master", optional: true},
      {:castore, "~> 0.1", optional: true},
      {:mint, git: "https://github.com/elixir-mint/mint.git", branch: "main", optional: true},
